...
<definitions xmlns="http://www.omg.org/spec/BPMN/20100524/MODEL" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:camunda="http://camunda.org/schema/1.0/bpmn">
  <process id="theProcess" isExecutable="true">
    ...
    <serviceTask id="serviceTask2" name="Get with var" camunda:expression="\${services.getService(variables.choice)}" camunda:resultvariable="my-choice" />
...
engine.execute({
  services: {
    ...
    getService: (choice) => {
      ...
      return function myService(context, next) {
...
engine.once('end', (execution) => {
  console.log('Completed!', execution.getOutput());
});
```

## Camunda Property (deprecated)
